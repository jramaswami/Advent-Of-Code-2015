...
```1``` damage. So, if the attacker has a damage score of ```8```, and
the defender has an armor score of ```3```, the defender loses ```5```
hit points. If the defender had an armor score of ```300```, the
...
For example, suppose you have ```8``` hit points, ```5``` damage, and
```5``` armor, and that the boss has ```12``` hit points, ```7```
damage, and ```2``` armor:


* The player deals ```5-2 = 3``` damage; the boss goes down to ```9```
  hit points.
* The boss deals ```7-5 = 2``` damage; the player goes down to ```6```
  hit points.
* The player deals ```5-2 = 3``` damage; the boss goes down to ```6```
  hit points.
* The boss deals ```7-5 = 2``` damage; the player goes down to ```4```
  hit points.
* The player deals ```5-2 = 3``` damage; the boss goes down to ```3```
  hit points.
* The boss deals ```7-5 = 2``` damage; the player goes down to ```2```
  hit points.
* The player deals ```5-2 = 3``` damage; the boss goes down to ```0```
  hit points.
