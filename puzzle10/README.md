...
each run of digits (like ``111``) with the number of digits (``3``) followed
...
this sequence][conway] (that's Conway of *Conway's Game of Life* fame).
...
* * * 
:star:[Day 10 Solutions](https://www.reddit.com/3w6h3m)

[look-and-say]: https://en.wikipedia.org/wiki/Look-and-say_sequence
[conway]: https://www.youtube.com/watch?v=ea7lJkEhytA
