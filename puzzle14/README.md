...
Comet is in the lead at `1120` km (poor Dancer has only gotten `1056` km
by that point).  So, in this situation, Comet would win (if the race
...
:star:[Day 14 Solutions](https://www.reddit.com/3wqtx2)
