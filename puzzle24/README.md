...
and `7` through `11`. For this situation, the unique first groups, their
...
Given the example packages above, this would be the new unique first
...
of packages in the first group: `11 4`, `10 5`, and `8 7`. Of these, `11
4` has the lowest quantum entanglement, and so it is selected.
...
See http://adventofcode.com/day/24

* * * 

:star:[Day 24 Solutions](https://www.reddit.com/3y1s7f)
