...
(for security reasons), so he finds his new password by *incrementing*
...
* `hijklmmn` meets the first requirement (because it contains the straight `hi`j)
...
:star:[Day 11 Solutions](https://www.reddit.com/3wbzyv)
